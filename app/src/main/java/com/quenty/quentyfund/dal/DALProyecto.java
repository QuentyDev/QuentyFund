...
public class DALProyecto {
    ...
    public static final String TABLA = "Proyecto";
    public static final String COLUMNAS = "id,nombre,descripcion,monto,diasvigencia,categoriaid";
    public static final String CREATE_TABLA = "CREATE TABLE " + TABLA + " (id integer,firstName text,lastName text,email text)";

    public DALProyecto(SQLiteDatabase sqLiteDatabase) {
        db = sqLiteDatabase;
    }
